...
def _catalog_capability(
    *,
    ...
    """Build a catalog entry with pricing sourced from the canonical pricing authority.

    R-ARCH-03: token pricing (input/output/cache-read/cache-write) is defined
    exactly once in ``app.optimizer.provider_pricing.PRICING_CATALOG``; this
    catalog contributes only the capability dimensions (context window,
    tool/stream/JSON support, prompt-cache policy, minimum cacheable prefix).
    """
...
class ModelCapabilityCatalog:
    ...
    _CATALOG: dict[str, ModelCapabilities] = {
        # Anthropic
        "claude-3-5-sonnet": _catalog_capability(
            provider="anthropic",
        ...
        "claude-3-haiku": _catalog_capability(
            provider="anthropic",
        ...
        "claude-3-opus": _catalog_capability(
            provider="anthropic",
            model="claude-3-opus",
            context_window=200_000,
            supports_prompt_cache=True,
        ...
        "gpt-4o-mini": _catalog_capability(
            provider="openai",
            model="gpt-4o-mini",
            context_window=128_000,
            supports_prompt_cache=True,
        ...
        # Google Gemini
        "gemini-1.5-flash": _catalog_capability(
            provider="gemini",
        ...
        "gemini-1.5-pro": _catalog_capability(
            provider="gemini",
        ...
        "gemini-2.0-flash": _catalog_capability(
            provider="gemini",
        ...
        # Groq
        "llama-3.3-70b-versatile": _catalog_capability(
            provider="groq",
        ...
        "llama-3.1-8b-instant": _catalog_capability(
            provider="groq",
        ...
        # DeepSeek
        "deepseek-chat": _catalog_capability(
            provider="deepseek",
            model="deepseek-chat",
        ...
        "deepseek-reasoner": _catalog_capability(
            provider="deepseek",
        ...
        # OpenRouter
        "openrouter/auto": _catalog_capability(
            provider="openrouter",
        ...
        "local-model": _catalog_capability(
            provider="local",
            model="local-model",
